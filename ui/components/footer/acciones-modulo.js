...
export const ACCIONES_MODULO = [
  { id: 'aihub-add-llm', icon: 'plus', title: 'Añadir LLM', onClick: aihubOpenAddLlm },
  {
  ...
  { id: 'aihub-load-clipboard', icon: 'clipboard', title: 'Cargar portapapeles a Notas', onClick: aihubLoadClipboard },
  { id: 'aihub-inject-protocol', icon: 'braces', title: 'Copiar instrucciones JSON Family', onClick: aihubInjectProtocol },
];
